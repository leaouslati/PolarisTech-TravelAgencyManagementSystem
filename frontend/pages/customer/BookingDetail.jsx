    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
      <div className="w-full max-w-3xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="flex items-center gap-3 mb-6">
          <button
            onClick={() => navigate(-1)}
            className="p-1.5 rounded-lg text-slate-500 hover:text-slate-700 hover:bg-slate-100 dark:text-slate-400 dark:hover:text-slate-200 dark:hover:bg-slate-700 transition-colors"
          >
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-0.5">Full details for your booking</p>
          </div>
          <span className={`ml-auto px-3 py-1 rounded-full text-xs font-semibold ${getStatusClass(booking.status)}`}>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm mb-4">
          <div className="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
            <h2 className="text-sm font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wide">Package</h2>
          </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm mb-4">
          <div className="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
            <h2 className="text-sm font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wide">Booking Details</h2>
          </div>
          <div className="px-5 py-2">
        ...
        {booking.addons?.length > 0 && (
          <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm mb-4">
            <div className="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
              <h2 className="text-sm font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wide">Add-ons</h2>
            </div>
            <div className="px-5 py-2">
              ...
              <div className="flex justify-between py-2.5">
                <span className="text-sm font-medium text-slate-600 dark:text-slate-400">Add-ons Total</span>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm mb-4">
          <div className="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
            <h2 className="text-sm font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wide">Payment</h2>
          </div>
          <div className="px-5 py-2">
            <InfoRow label="Package Price (per person)" value={`$${Number(booking.package_price).toLocaleString()}`} />
            ...
            <div className="flex justify-between py-2.5">
              ...
              <span className={`px-2.5 py-0.5 text-xs font-medium rounded-full ${getPaymentClass(booking.payment_status)}`}>
        ...
        <div className="flex flex-wrap gap-3 mt-2">
          ...
          <Link
            ...
            className="px-5 py-2.5 bg-white dark:bg-slate-700 hover:bg-slate-50 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-300 text-sm font-medium rounded-lg border border-slate-200 dark:border-slate-600 transition-colors"
          >
            ← Back to My Bookings
          </Link>
        </div>
